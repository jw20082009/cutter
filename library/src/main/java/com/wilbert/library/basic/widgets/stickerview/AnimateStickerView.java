...
package com.wilbert.library.basic.widgets.stickerview;
...
import com.wilbert.library.basic.entity.StickerResultEntity;
...
public class AnimateStickerView extends StickerView {
    ...
    private void init() {
        ...
        textPadding = DensityUtils.dp2px(getContext(), 10);
    }
    ...
    private TextPaint getTextPaint() {
        if (textPaint == null) {
            ...
            textPaint.setTextSize(DensityUtils.dp2px(getContext(), 20));

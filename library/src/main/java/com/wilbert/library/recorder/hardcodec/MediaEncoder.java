 ...
 */
public abstract class MediaEncoder implements Runnable, IEncoder {
    protected static final boolean DEBUG = false;    // TODO set false on release
    protected static final String TAG = "MediaEncoder";
    protected static final int TIMEOUT_USEC = 10000;    // 10[msec]
    protected IMediaEncoderListener mListener;
    /**
     * Weak refarence of IMuxer instance
     */
    protected final WeakReference<IMuxer> mWeakMuxer;
    ...
    public MediaEncoder(IMuxer muxer, IMediaEncoderListener listener) {
...
//		android.os.Process.setThreadPriority(android.os.Process.THREAD_PRIORITY_URGENT_AUDIO);
        ...
        while (isRunning) {
            ...
            Log.i(TAG,"localRequestStop:"+localRequestStop+";"+mTrackIndex);
            if (localRequestStop) {
                drain();
    ...
    public void drain() {
        ...
        final IMuxer muxer = mWeakMuxer.get();
        if (muxer == null) {
//        	throw new NullPointerException("muxer is unexpectedly null");
    ...
    public void release() {
        ...
        if (mMuxerStarted) {
            final IMuxer muxer = mWeakMuxer != null ? mWeakMuxer.get() : null;
            if (muxer != null) {
                try {
                    muxer.stop();
                } catch (final Exception e) {

package com.wilbert.library.basic.widgets.rangeseekbar;
...
public class CrystalRangeSeekbar extends View {
    ...
    public CrystalRangeSeekbar(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray array = context.obtainStyledAttributes(attrs, R.styleable.sample_CrystalRangeSeekbar);
        try{
    ...
    protected float getThumbWidth(){
        return (leftThumb != null)  ? leftThumb.getWidth() : getResources().getDimension(R.dimen.basic_thumb_width);
    }

    protected float getThumbHeight(){
        return (leftThumb != null)  ? leftThumb.getHeight() : getResources().getDimension(R.dimen.basic_thumb_height);
    }

    protected float getThumbDiameter(){
        return (thumbDiameter > 0) ? thumbDiameter :  getResources().getDimension(R.dimen.basic_thumb_width);
    }
    protected float getBarHeight(){
        return _barHeight > 0 ? _barHeight : thumbHeight;
    }
    ...
    protected float getCornerRadius(final TypedArray typedArray){
        return typedArray.getFloat(R.styleable.sample_CrystalRangeSeekbar_corner_radius, 0f);
    }

    protected float getMinValue(final TypedArray typedArray){
        return typedArray.getFloat(R.styleable.sample_CrystalRangeSeekbar_min_value, 0f);
    }

    protected float getMaxValue(final TypedArray typedArray){
        return typedArray.getFloat(R.styleable.sample_CrystalRangeSeekbar_max_value, 100f);
    }

    protected float getMinStartValue(final TypedArray typedArray){
        return typedArray.getFloat(R.styleable.sample_CrystalRangeSeekbar_min_start_value, minValue);
    }

    protected float getMaxStartValue(final TypedArray typedArray){
        return typedArray.getFloat(R.styleable.sample_CrystalRangeSeekbar_max_start_value, maxValue);
    }

    protected float getSteps(final TypedArray typedArray){
        return typedArray.getFloat(R.styleable.sample_CrystalRangeSeekbar_steps, NO_STEP);
    }

    protected float getGap(final TypedArray typedArray){
        return typedArray.getFloat(R.styleable.sample_CrystalRangeSeekbar_gap, 0f);
    }

    protected float getFixedGap(final TypedArray typedArray){
        return typedArray.getFloat(R.styleable.sample_CrystalRangeSeekbar_fix_gap, NO_FIXED_GAP);
    }

    protected int getBarColorMode(final TypedArray typedArray) {
        return typedArray.getInt(R.styleable.sample_CrystalRangeSeekbar_bar_color_mode,ColorMode.SOLID);
    }

    protected float getBarHeight(final TypedArray typedArray){
        return typedArray.getDimensionPixelSize(R.styleable.sample_CrystalRangeSeekbar_bar_height, 0);
    }

    protected int getBarColor(final TypedArray typedArray) {
        return typedArray.getColor(R.styleable.sample_CrystalRangeSeekbar_bar_color, Color.TRANSPARENT);
    }

    protected int getBarGradientStart(final TypedArray typedArray) {
        return typedArray.getColor(R.styleable.sample_CrystalRangeSeekbar_bar_gradient_start, getResources().getColor(R.color.basic_progressBar));
    }

    protected int getBarGradientEnd(final TypedArray typedArray) {
        return typedArray.getColor(R.styleable.sample_CrystalRangeSeekbar_bar_gradient_end, getResources().getColor(R.color.basic_progressBar));
    }

    protected int getBarHighlightColorMode(final TypedArray typedArray) {
        return typedArray.getInt(R.styleable.sample_CrystalRangeSeekbar_bar_highlight_color_mode, ColorMode.SOLID);
    }

    protected int getBarHighlightColor(final TypedArray typedArray) {
        return typedArray.getColor(R.styleable.sample_CrystalRangeSeekbar_bar_highlight_color, getResources().getColor(R.color.basic_progressBar2));
    }

    protected int getBarHighlightGradientStart(final TypedArray typedArray) {
        return typedArray.getColor(R.styleable.sample_CrystalRangeSeekbar_bar_highlight_gradient_start, getResources().getColor(R.color.basic_progressBar2));
    }

    protected int getBarHighlightGradientEnd(final TypedArray typedArray) {
        return typedArray.getColor(R.styleable.sample_CrystalRangeSeekbar_bar_highlight_gradient_end, getResources().getColor(R.color.basic_progressBar));
    }

    protected int getLeftThumbColor(final TypedArray typedArray){
        return typedArray.getColor(R.styleable.sample_CrystalRangeSeekbar_left_thumb_color,getResources().getColor(R.color.basic_progressBar));
    }

    protected int getRightThumbColor(final TypedArray typedArray){
        return typedArray.getColor(R.styleable.sample_CrystalRangeSeekbar_right_thumb_color,getResources().getColor(R.color.basic_progressBar));
    }

    protected int getLeftThumbColorPressed(final TypedArray typedArray){
        return typedArray.getColor(R.styleable.sample_CrystalRangeSeekbar_left_thumb_color_pressed,getResources().getColor(R.color.basic_progressBar3));
    }

    protected int getRightThumbColorPressed(final TypedArray typedArray){
        return typedArray.getColor(R.styleable.sample_CrystalRangeSeekbar_right_thumb_color_pressed, getResources().getColor(R.color.basic_progressBar3));
    }

    protected Drawable getLeftDrawable(final TypedArray typedArray){
        return typedArray.getDrawable(R.styleable.sample_CrystalRangeSeekbar_left_thumb_image);
    }

    protected Drawable getRightDrawable(final TypedArray typedArray){
        return typedArray.getDrawable(R.styleable.sample_CrystalRangeSeekbar_right_thumb_image);
    }

    protected Drawable getLeftDrawablePressed(final TypedArray typedArray){
        return typedArray.getDrawable(R.styleable.sample_CrystalRangeSeekbar_left_thumb_image_pressed);
    }

    protected Drawable getRightDrawablePressed(final TypedArray typedArray){
        return typedArray.getDrawable(R.styleable.sample_CrystalRangeSeekbar_right_thumb_image_pressed);
    }

    protected int getDataType(final TypedArray typedArray){
        return typedArray.getInt(R.styleable.sample_CrystalRangeSeekbar_data_type, DataType.INTEGER);
    }

    protected boolean isSeekBarTouchEnabled(final TypedArray typedArray){
        return typedArray.getBoolean(R.styleable.sample_CrystalRangeSeekbar_seek_bar_touch_enabled, false);
    }

    protected float getDiameter(final TypedArray typedArray){
        return typedArray.getDimensionPixelSize(R.styleable.sample_CrystalRangeSeekbar_thumb_diameter, getResources().getDimensionPixelSize(R.dimen.basic_thumb_height));
    }

package com.wilbert.library.videoprocessor.util;
...
import com.wilbert.library.videoprocessor.VideoUtil;
import com.wilbert.library.videoprocessor.jssrc.SSRC;
...
public class AudioUtil {
     ...
     * @throws IOException
     */
    public static void decodeToPCMwithSpeed(String audioPath, String outPath, Integer startTimeUs, Integer endTimeUs, float speed) throws IOException {
        MediaExtractor extractor = new MediaExtractor();
